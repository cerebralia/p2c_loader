...
bool License::CheckVersion()
{
	string UrlRequest = PATH;
	UrlRequest.append("gate.php?version=ok");

	string GetCheatVersion = GetUrlData(UrlRequest, HOST);
